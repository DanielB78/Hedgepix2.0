...
8. Labels each new title with top-3 NAICS industries (5-digit) via local BGE-small (`BAAI/bge-small-en-v1.5`) cosine similarity against cached Census NAICS templates
